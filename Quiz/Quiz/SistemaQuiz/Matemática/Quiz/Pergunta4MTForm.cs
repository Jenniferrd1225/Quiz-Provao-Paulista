...
{
	/// <summary>
	/// Description of Pergunta4MTForm.
	/// </summary>
	public partial class Pergunta4MTForm : Form
	{
		int pontosMT;
		public Pergunta4MTForm(int pontos)
		{
			//
		...
		void BtnBClick(object sender, EventArgs e)
        {
            ...
            Pergunta5MTForm Pergunta5MTForm = new Pergunta5MTForm(pontosMT);
            Pergunta5MTForm.Show();
            this.Hide();
