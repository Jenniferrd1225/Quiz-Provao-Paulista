...
{
	/// <summary>
	/// Description of Pergunta5MTForm.
	/// </summary>
	public partial class Pergunta5MTForm : Form
	{
		int pontosMT;
		public Pergunta5MTForm(int pontos)
		{
			//
        ...
        {
            FinalizarQuizMTForm FinalizarQuizMTForm = new FinalizarQuizMTForm(pontosMT);
            FinalizarQuizMTForm.Show();
            this.Hide();
        }
    }
}
