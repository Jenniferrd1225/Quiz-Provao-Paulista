...
{
	/// <summary>
	/// Description of Pergunta2MTForm.
	/// </summary>
	public partial class Pergunta2MTForm : Form
	{
		int pontosMT;
		public Pergunta2MTForm(int pontos)
		{
			//
		...
		void BtnBClick(object sender, EventArgs e)
        {
            ...
            Pergunta3MTForm Pergunta3MTForm = new Pergunta3MTForm(pontosMT);
            Pergunta3MTForm.Show();
            this.Hide();
