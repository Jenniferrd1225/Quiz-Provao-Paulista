...
{
	/// <summary>
	/// Description of Resumo1MTForm.
	/// </summary>
	public partial class Resumo1MTForm : Form
	{
		public Resumo1MTForm()
		{
			//
		...
		void Button1Click(object sender, EventArgs e)
		{
			...
			FinalizarResumoMTForm FinalizarResumoMTForm = new FinalizarResumoMTForm(pontosRM);
            FinalizarResumoMTForm.Show();
            this.Hide();
		}
    }
}
