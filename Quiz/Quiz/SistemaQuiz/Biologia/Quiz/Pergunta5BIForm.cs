...
{
	/// <summary>
	/// Description of Pergunta5BIForm.
	/// </summary>
	public partial class Pergunta5BIForm : Form
	{
		int pontosBI;
		public Pergunta5BIForm(int pontos)
		{
			//
		...
		{
            FinalizarQuizBIForm FinalizarQuizBIForm = new FinalizarQuizBIForm(pontosBI);
            FinalizarQuizBIForm.Show();
            this.Hide();
		}
    }
}
