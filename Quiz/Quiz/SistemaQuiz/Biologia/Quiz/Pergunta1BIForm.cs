...
{
	/// <summary>
	/// Description of Pergunta1BIForm.
	/// </summary>
	public partial class Pergunta1BIForm : Form
	{
		public Pergunta1BIForm()
		{
			//
		         ...
		         void BtnBClick(object sender, EventArgs e)
        {
            ...
            Pergunta2BIForm Pergunta2BIForm = new Pergunta2BIForm(pontosBI);
			Pergunta2BIForm.Show();
			this.Hide();
