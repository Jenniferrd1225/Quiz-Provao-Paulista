...
namespace SistemaQuiz
{
	partial class Pergunta3BIForm
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Pergunta3BIForm));
			...
			this.panel6.Location = new System.Drawing.Point(800, 431);
			...
			this.label9.Text = "D) Mais nutrientes → mais algas → água sombreada → plantas morrem → bactérias con" +
			"somem O₂ → peixes morrem.";
			...
			this.panel7.Location = new System.Drawing.Point(800, 277);
			...
			this.label10.Text = "C) Mais nutrientes → mais decompositores → menos CO₂ → água ácida → peixes morrem" +
			".";
			...
			this.panel5.Location = new System.Drawing.Point(286, 431);
			...
			this.label8.Text = "B) Mais nutrientes → algas em excesso → menos luz → plantas morrem → falta de O₂ " +
			"→ peixes morrem.";
			...
			this.panel4.Location = new System.Drawing.Point(286, 277);
			...
			this.label6.Text = "A) Mais nutrientes → mais peixes → disputa por espaço → morte.";
			...
			this.label5.Size = new System.Drawing.Size(1018, 172);
			...
			this.Name = "Pergunta3BIForm";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Pergunta3BIForm";
