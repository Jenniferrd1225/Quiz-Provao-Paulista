...
namespace SistemaQuiz
{
	partial class Pergunta2BIForm
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Pergunta2BIForm));
			...
			this.label9.Text = "D) Elas absorvem grandes quantidades de fósforo, liberando-o após a colheita.";
			...
			this.label10.Text = "C) Elas estabelecem simbiose com bactérias fixadoras de nitrogênio, enriquecendo " +
			...
			this.label8.Text = "B) Suas folhas largas impedem a lixiviação do potássio.";
			...
			this.label6.Text = "A) Suas raízes profundas quebram o ciclo do carbono, sequestrando-o no subsolo.";
			...
			this.Name = "Pergunta2BIForm";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Pergunta2BIForm";
