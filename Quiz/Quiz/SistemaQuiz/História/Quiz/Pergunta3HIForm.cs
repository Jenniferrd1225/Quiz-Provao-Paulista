...
{
	/// <summary>
	/// Description of Pergunta3HIForm.
	/// </summary>
	public partial class Pergunta3HIForm : Form
	{
		int pontosHI;
		public Pergunta3HIForm(int pontos)
		{
			//
		      ...
		      void BtnBClick(object sender, EventArgs e)
        {
            ...
            Pergunta4HIForm Pergunta4HIForm = new Pergunta4HIForm(pontosHI);
            Pergunta4HIForm.Show();
            this.Hide();
