...
{
	/// <summary>
	/// Description of Pergunta1HIForm.
	/// </summary>
	public partial class Pergunta1HIForm : Form
	{
		public Pergunta1HIForm()
		{
			//
		      ...
		      void BtnBClick(object sender, EventArgs e)
        {
            ...
            Pergunta2HIForm Pergunta2HIForm = new Pergunta2HIForm(pontosHI);
            Pergunta2HIForm.Show();
            this.Hide();
