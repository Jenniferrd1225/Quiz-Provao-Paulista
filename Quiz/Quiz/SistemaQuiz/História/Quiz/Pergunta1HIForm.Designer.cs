...
namespace SistemaQuiz
{
	partial class Pergunta1HIForm
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Pergunta1HIForm));
			...
			this.label9.Text = "D) O afluxo em grande quantidade de ouro e prata provenientes da América, que des" +
	"valorizou a moeda e aumentou os preços.";
			...
			this.label8.Text = "B) A emissão descontrolada de papel-moeda pelos Estados Nacionais para financiar " +
	"novas expedições marítimas.";
			...
			this.label10.Text = "C) A concentração de metais preciosos nas mãos da Igreja Católica, que retirou es" +
	"se dinheiro de circulação.";
			...
			this.label6.Text = "A) A descoberta de novas técnicas agrícolas nas Américas, que aumentou a oferta d" +
	"e alimentos e barateou seus custos.";
			...
			this.Name = "Pergunta1HIForm";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Pergunta1HIForm";
