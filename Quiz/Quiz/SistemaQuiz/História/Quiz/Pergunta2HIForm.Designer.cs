...
namespace SistemaQuiz
{
	partial class Pergunta2HIForm
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Pergunta2HIForm));
			...
			this.panel6.Location = new System.Drawing.Point(358, 351);
			...
			this.label9.Text = "D) Estabelecer zonas de influência religiosa, definindo onde cada nação poderia c" +
	"atequizar os povos nativos.";
			...
			this.panel5.Location = new System.Drawing.Point(16, 351);
			...
			this.label8.Text = "B) Impedir que outras nações europeias, como França e Inglaterra, participassem d" +
	"a partilha das novas terras.";
			...
			this.panel7.Location = new System.Drawing.Point(358, 251);
			...
			this.label10.Text = "C) Garantir o domínio espanhol sobre todo o continente americano, já descoberto p" +
	"or Colombo.";
			...
			this.panel4.Location = new System.Drawing.Point(16, 251);
			...
			this.label6.Text = "A) Solucionar os conflitos decorrentes da chegada de Colombo à América, asseguran" +
	"do a Portugal a rota para as Índias e seus direitos sobre terras no Atlântico.";
			...
			this.Name = "Pergunta2HIForm";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Pergunta2HIForm";
