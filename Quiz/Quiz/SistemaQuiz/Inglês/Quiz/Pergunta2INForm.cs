...
{
	/// <summary>
	/// Description of Pergunta2INForm.
	/// </summary>
	public partial class Pergunta2INForm : Form
	{
		int pontosIN;
		public Pergunta2INForm(int pontos)
		{
			//
         ...
         void BtnBClick(object sender, EventArgs e)
        {
            ...
            respostaSelecionada = true;
           	...
           	Pergunta3INForm Pergunta3INForm = new Pergunta3INForm(pontosIN);
			Pergunta3INForm.Show();
			this.Hide();
