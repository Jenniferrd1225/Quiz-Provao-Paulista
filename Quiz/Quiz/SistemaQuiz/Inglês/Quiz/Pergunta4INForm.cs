...
{
	/// <summary>
	/// Description of Pergunta4INForm.
	/// </summary>
	public partial class Pergunta4INForm : Form
	{
		int pontosIN;
		public Pergunta4INForm(int pontos)
		{
			//
         ...
         void BtnBClick(object sender, EventArgs e)
        {
            ...
            respostaSelecionada = true;
           	...
           	Pergunta5INForm Pergunta5INForm = new Pergunta5INForm(pontosIN);
			Pergunta5INForm.Show();
			this.Hide();
