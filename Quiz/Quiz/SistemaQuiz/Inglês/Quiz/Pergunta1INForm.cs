...
{
	/// <summary>
	/// Description of Pergunta1INForm.
	/// </summary>
	public partial class Pergunta1INForm : Form
	{
		public Pergunta1INForm()
		{
			//
         ...
         void BtnBClick(object sender, EventArgs e)
        {
            ...
            respostaSelecionada = true;
           	...
           	Pergunta2INForm Pergunta2INForm = new Pergunta2INForm(pontosIN);
			Pergunta2INForm.Show();
			this.Hide();
