...
{
	/// <summary>
	/// Description of Pergunta3QUForm.
	/// </summary>
	public partial class Pergunta3QUForm : Form
	{
		int pontosQU;
		public Pergunta3QUForm(int pontos)
		{
			//
		         ...
		         void BtnBClick(object sender, EventArgs e)
        {
            ...
            Pergunta4QUForm Pergunta4QUForm = new Pergunta4QUForm(pontosQU);
            Pergunta4QUForm.Show();
            this.Hide();
