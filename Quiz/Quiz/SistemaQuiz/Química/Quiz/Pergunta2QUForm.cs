...
{
	/// <summary>
	/// Description of Pergunta2QUForm.
	/// </summary>
	public partial class Pergunta2QUForm : Form
	{
		int pontosQU;
		public Pergunta2QUForm(int pontos)
		{
			//
		         ...
		         void BtnBClick(object sender, EventArgs e)
        {
            ...
            Pergunta3QUForm Pergunta3QUForm = new Pergunta3QUForm(pontosQU);
            Pergunta3QUForm.Show();
            this.Hide();
