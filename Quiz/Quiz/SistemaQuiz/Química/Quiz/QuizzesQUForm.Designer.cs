...
namespace SistemaQuiz
{
	partial class QuizzesQUForm
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(QuizzesQUForm));
			...
			this.label2.Text = "Possuímos 1 quiz sobre Química, composto por 5\r\nperguntas. Cada pergunta vale por" +
	" 1 ponto.";
			...
			this.label1.Text = "QUIZ DE QUÍMICA";
			...
			this.label4.Size = new System.Drawing.Size(435, 39);
			...
			this.label5.Text = "TEMA: Átomo e sua estrutura\r\n\r\nCONTEÚDO: Teoria de Dalton — Partículas Elementare" +
	"s — Semelhança entre Átomos.";
			// 
			// label8
			// 
			...
			this.Name = "QuizzesQUForm";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "QuizzesQUForm";
