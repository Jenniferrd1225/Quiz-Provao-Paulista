...
{
	/// <summary>
	/// Description of Pergunta4QUForm.
	/// </summary>
	public partial class Pergunta4QUForm : Form
	{
		int pontosQU;
		public Pergunta4QUForm(int pontos)
		{
			//
		         ...
		         void BtnBClick(object sender, EventArgs e)
        {
            ...
            Pergunta5QUForm Pergunta5QUForm = new Pergunta5QUForm(pontosQU);
            Pergunta5QUForm.Show();
            this.Hide();
