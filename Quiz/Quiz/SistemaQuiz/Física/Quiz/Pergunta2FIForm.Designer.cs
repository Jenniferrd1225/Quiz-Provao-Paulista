...
namespace SistemaQuiz
{
	partial class Pergunta2FIForm
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Pergunta2FIForm));
			...
			this.label9.Text = "D) A força gravitacional sobre ele é nula";
			...
			this.label10.Text = "C) Ele está fora do campo gravitacional terrestre";
			...
			this.label8.Text = "B) Ele e a estação estão em queda livre, sujeitos principalmente à gravidade terr" +
			"estre";
			...
			this.label6.Text = "A) Sua massa tornou-se zero no espaço";
			...
			this.Name = "Pergunta2FIForm";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Pergunta2FIForm";
