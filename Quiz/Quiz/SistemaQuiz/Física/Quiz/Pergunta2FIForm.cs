...
{
	/// <summary>
	/// Description of Pergunta2FIForm.
	/// </summary>
	public partial class Pergunta2FIForm : Form
	{
		int pontosFI;
		public Pergunta2FIForm(int pontos)
		{
			//
		 ...
		 void BtnBClick(object sender, EventArgs e)
        {
            ...
            Pergunta3FIForm Pergunta3FIForm = new Pergunta3FIForm(pontosFI);
			Pergunta3FIForm.Show();
			this.Hide();
