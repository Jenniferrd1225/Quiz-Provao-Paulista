...
{
	/// <summary>
	/// Description of Pergunta5FIForm.
	/// </summary>
	public partial class Pergunta5FIForm : Form
	{
		int pontosFI;
		public Pergunta5FIForm(int pontos)
		{
			//
		...
		{
            FinalizarQuizFIForm FinalizarQuizFIForm = new FinalizarQuizFIForm(pontosFI);
            FinalizarQuizFIForm.Show();
            this.Hide();			
		}
    }
}
