...
namespace SistemaQuiz
{
	partial class QuizzesFIForm
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(QuizzesFIForm));
			...
			this.label2.Text = "Possuímos 1 quiz sobre Física, composto por 5\r\nperguntas. Cada pergunta vale por " +
	"1 ponto.";
			...
			this.label1.Text = "QUIZ DE FÍSICA";
	...
	"rimeira Lei de Newton — Referencial Inercial.\r\n";
			...
			this.Name = "QuizzesFIForm";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "QuizzesFIForm";
