...
namespace SistemaQuiz
{
	partial class ResumosFIForm
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ResumosFIForm));
			...
			this.label2.Text = "Possuímos 1 resumo de Física. Cada resumo vale 10\r\npontos, e eles serão somados a" +
	"pós a conclusão da leitura.";
			...
			this.label1.Text = "RESUMO DE FÍSICA";
			...
			this.label5.Text = "TEMA: Movimento e as Leis de Newton\r\n\r\nCONTEÚDO: Força — Composição de forças — P" +
	"rimeira Lei de Newton — Referencial Inercial.\r\n";
			// 
			// label8
			// 
			...
			this.Name = "ResumosFIForm";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "ResumosFIForm";
