...
{
	/// <summary>
	/// Description of ResumoGEForm.
	/// </summary>
	public partial class ResumoGEForm : Form
	{
		public ResumoGEForm()
		{
			//
		...
		void BtnFinalizarClick(object sender, EventArgs e)
		{
			...
			FinalizarResumoGEForm FinalizarResumoGEForm = new FinalizarResumoGEForm(pontosRG);
            FinalizarResumoGEForm.Show();
            this.Hide();
		}
