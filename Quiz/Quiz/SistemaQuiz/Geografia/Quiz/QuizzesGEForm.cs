...
{
	/// <summary>
	/// Description of QuizzesGEForm.
	/// </summary>
	public partial class QuizzesGEForm : Form
	{
		public QuizzesGEForm()
		{
			//
		...
		{
            Pergunta1GEForm Pergunta1GEForm = new Pergunta1GEForm();
            Pergunta1GEForm.Show();
            this.Hide();
		}
    }
}
