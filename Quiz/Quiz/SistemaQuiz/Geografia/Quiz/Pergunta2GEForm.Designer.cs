...
namespace SistemaQuiz
{
	partial class Pergunta2GEForm
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Pergunta2GEForm));
			...
			this.panel6.Location = new System.Drawing.Point(358, 381);
			...
			this.label9.Text = "D) A participação dos \"Outros\", somando 32%, demonstra a irrelevância econômica d" +
	"os países emergentes no cenário futuro.";
			...
			this.panel5.Location = new System.Drawing.Point(16, 381);
			...
			this.label8.Text = "B) Os países citados formarão uma única aliança econômica contra o resto do mundo" +
	", inviabilizando a multipolaridade.";
			...
			this.panel7.Location = new System.Drawing.Point(358, 281);
			...
			this.label10.Text = "C) O poder econômico mundial estará distribuído entre vários polos ou centros de " +
	"poder, caracterizando a multipolaridade.";
			...
			this.panel4.Location = new System.Drawing.Point(16, 281);
			...
			this.label6.Text = "A) A economia global será dominada por uma única potência hegemônica, os Estados " +
	"Unidos.";
			...
			this.label5.Size = new System.Drawing.Size(699, 201);
			...
			this.Name = "Pergunta2GEForm";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Pergunta2GEForm";
