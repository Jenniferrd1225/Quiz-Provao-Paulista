...
namespace SistemaQuiz
{
	partial class Pergunta1GEForm
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Pergunta1GEForm));
			...
			this.label9.Text = "D) Colonialismo – retomada da prática de dominação política e econômica de outros" +
	" territórios.";
			...
			this.label8.Text = "B) Nacionalismo soberanista – rejeição a acordos supranacionais e defesa intransi" +
	"gente da soberania nacional.";
			...
			this.label10.Text = "C) Cosmopolitismo – adoção de valores e identidades puramente globais.";
			...
			this.label6.Text = "A) Expansionismo militar – busca por anexação de territórios pela força.";
			...
			this.Name = "Pergunta1GEForm";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Pergunta1GEForm";
