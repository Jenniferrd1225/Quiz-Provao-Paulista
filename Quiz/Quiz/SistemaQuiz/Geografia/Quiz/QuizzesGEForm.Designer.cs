...
namespace SistemaQuiz
{
	partial class QuizzesGEForm
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(QuizzesGEForm));
			...
			this.label2.Text = "Possuímos 1 quiz sobre Geografia, cada um composto por 5\r\nperguntas. Cada pergunt" +
	"a vale por 1 ponto.";
			...
			this.label1.Text = "QUIZZES DE GEOGRAFIA";
	...
	"órico — Características Principais — Atualidades.\r\n\r\n";
			...
			this.Name = "QuizzesGEForm";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "QuizzesGEForm";
