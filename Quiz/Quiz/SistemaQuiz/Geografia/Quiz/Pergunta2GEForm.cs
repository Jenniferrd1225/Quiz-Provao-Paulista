...
{
	/// <summary>
	/// Description of Pergunta2GEForm.
	/// </summary>
	public partial class Pergunta2GEForm : Form
	{
		int pontosGE;
		public Pergunta2GEForm(int pontos)
		{
			//
		         ...
		         void BtnBClick(object sender, EventArgs e)
        {
            ...
            Pergunta3GEForm Pergunta3GEForm = new Pergunta3GEForm(pontosGE);
            Pergunta3GEForm.Show();
            this.Hide();
