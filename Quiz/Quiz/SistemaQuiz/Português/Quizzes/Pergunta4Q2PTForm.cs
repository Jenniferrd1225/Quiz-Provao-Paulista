...
{
	/// <summary>
	/// Description of Pergunta4Q2PTForm.
	/// </summary>
	public partial class Pergunta4Q2PTForm : Form
	{
		int pontosPT;
		public Pergunta4Q2PTForm(int pontos)
		{
			//
         ...
         void BtnBClick(object sender, EventArgs e)
        {
            ...
            Pergunta5Q2PTForm Pergunta5Q2PTForm = new Pergunta5Q2PTForm(pontosPT);
            Pergunta5Q2PTForm.Show();
            this.Hide();
