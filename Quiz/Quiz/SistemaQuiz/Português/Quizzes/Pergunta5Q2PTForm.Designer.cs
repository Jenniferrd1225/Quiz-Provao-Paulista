...
{
	partial class Pergunta5Q2PTForm
	{
		/// <summary>
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Pergunta5Q2PTForm));
			...
			this.label9.Text = "D) A exaltação da pátria e do nacionalismo romântico.";
			...
			this.label8.Text = "B) A objetividade, clareza e valorização da razão.";
			...
			this.label10.Text = "C) O dualismo, o cultismo (jogo de palavras) e o conceptismo (jogo de ideias).";
			...
			this.btnFinalizar.Location = new System.Drawing.Point(454, 447);
			this.btnFinalizar.Name = "btnFinalizar";
			this.btnFinalizar.Size = new System.Drawing.Size(130, 48);
			this.btnFinalizar.TabIndex = 144;
			...
			this.label6.Text = "A) O bucolismo e a idealização da vida no campo.";
			...
			this.Name = "Pergunta5Q2PTForm";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Pergunta5Q2PTForm";
