...
{
	partial class Pergunta2Q2PTForm
	{
		/// <summary>
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Pergunta2Q2PTForm));
			...
			this.label9.Text = "D) O equilíbrio entre razão e emoção, com simplicidade e clareza de linguagem.";
			...
			this.label8.Text = "B) A dualidade entre pecado e perdão, marcada pela religiosidade intensa.";
			...
			this.label10.Text = "C) A valorização da subjetividade, do nacionalismo e da figura do índio como heró" +
	"i.";
			...
			this.label6.Text = "A) A idealização da vida campestre e a valorização da razão como guia da sociedad" +
	"e.";
			...
			this.Name = "Pergunta2Q2PTForm";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Pergunta2Q2PTForm";
