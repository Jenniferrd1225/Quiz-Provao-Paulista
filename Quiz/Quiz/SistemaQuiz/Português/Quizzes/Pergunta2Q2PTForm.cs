...
{
	/// <summary>
	/// Description of Pergunta2Q2PTForm.
	/// </summary>
	public partial class Pergunta2Q2PTForm : Form
	{
		int pontosPT;
		public Pergunta2Q2PTForm(int pontos)
		{
			//
		...
		void BtnBClick(object sender, EventArgs e)
		{
		    ...
		    Pergunta3Q2PTForm Pergunta3Q2PTForm = new Pergunta3Q2PTForm(pontosPT);
			Pergunta3Q2PTForm.Show();
			this.Hide();
		}
