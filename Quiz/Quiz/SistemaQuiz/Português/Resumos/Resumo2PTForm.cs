...
{
	/// <summary>
	/// Description of Resumo2PTForm.
	/// </summary>
	public partial class Resumo2PTForm : Form
	{
		public Resumo2PTForm()
		{
			//
		...
		void BtnProximaClick(object sender, EventArgs e)
		{
			...
			FinalizarResumoPTForm FinalizarResumoPTForm = new FinalizarResumoPTForm(pontosRP);
			FinalizarResumoPTForm.Show();
			this.Hide();	
		}
	}
}
