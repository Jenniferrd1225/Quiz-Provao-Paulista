...
{
	/// <summary>
	/// Description of ResumosPTForm.
	/// </summary>
	public partial class ResumosPTForm : Form
	{
		public ResumosPTForm()
		{
			//
		...
		void BtnResumo2Click(object sender, EventArgs e)
		{
			Resumo2PTForm Resumo2PTForm = new Resumo2PTForm();
			Resumo2PTForm.Show();
			this.Hide();
		}
	}
