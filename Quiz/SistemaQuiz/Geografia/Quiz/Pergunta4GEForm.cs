...
{
	/// <summary>
	/// Description of Pergunta4GEForm.
	/// </summary>
	public partial class Pergunta4GEForm : Form
	{
		int pontosGE;
		public Pergunta4GEForm(int pontos)
		{
			//
		         ...
		         void BtnBClick(object sender, EventArgs e)
        {
            ...
            Pergunta5GEForm Pergunta5GEForm = new Pergunta5GEForm(pontosGE);
            Pergunta5GEForm.Show();
            this.Hide();
