...
{
	/// <summary>
	/// Description of Pergunta1GEForm.
	/// </summary>
	public partial class Pergunta1GEForm : Form
	{
		public Pergunta1GEForm()
		{
			//
		         ...
		         void BtnBClick(object sender, EventArgs e)
        {
            ...
            Pergunta2GEForm Pergunta2GEForm = new Pergunta2GEForm(pontosGE);
            Pergunta2GEForm.Show();
            this.Hide();
