...
{
	/// <summary>
	/// Description of Pergunta5GEForm.
	/// </summary>
	public partial class Pergunta5GEForm : Form
	{
		int pontosGE;
		public Pergunta5GEForm(int pontos)
		{
			//
        ...
        {
            FinalizarQuizGEForm FinalizarQuizGEForm = new FinalizarQuizGEForm(pontosGE);
            FinalizarQuizGEForm.Show();
            this.Hide();
        }
    }
}
