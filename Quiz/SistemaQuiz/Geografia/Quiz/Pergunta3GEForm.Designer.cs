...
namespace SistemaQuiz
{
	partial class Pergunta3GEForm
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Pergunta3GEForm));
			...
			this.label9.Text = "D) A Organização do Tratado do Atlântico Norte (Otan) perdeu sua relevância após " +
	"o fim da Guerra Fria.";
			...
			this.label8.Text = "B) Os conflitos atuais são exclusivamente de natureza religiosa, sem relação com " +
	"a geopolítica.";
			...
			this.label10.Text = "C) A hegemonia militar russa é incontestável, tornando obsoleta a atuação de outr" +
	"os atores.";
			...
			this.label6.Text = "A) Apesar do fim da bipolaridade, tensões geopolíticas persistem em regiões de in" +
	"teresse estratégico.";
			...
			this.Name = "Pergunta3GEForm";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Pergunta3GEForm";
