...
{
	/// <summary>
	/// Description of Pergunta5INForm.
	/// </summary>
	public partial class Pergunta5INForm : Form
	{
		int pontosIN;
		public Pergunta5INForm(int pontos)
		{
			//
        ...
        {
            FinalizarQuizINForm FinalizarQuizINForm = new FinalizarQuizINForm(pontosIN);
            FinalizarQuizINForm.Show();
            this.Hide();
        }
    }
}
