...
{
	/// <summary>
	/// Description of QuizzesINForm.
	/// </summary>
	public partial class QuizzesINForm : Form
	{
		public QuizzesINForm()
		{
			//
		...
		{
            Pergunta1INForm Pergunta1INForm = new Pergunta1INForm();
            Pergunta1INForm.Show();
            this.Hide();
		}
    }
}
