...
{
	/// <summary>
	/// Description of Pergunta3INForm.
	/// </summary>
	public partial class Pergunta3INForm : Form
	{
		int pontosIN;
		public Pergunta3INForm(int pontos)
		{
			//
         ...
         void BtnBClick(object sender, EventArgs e)
        {
            ...
            respostaSelecionada = true;
           	...
           	Pergunta4INForm Pergunta4INForm = new Pergunta4INForm(pontosIN);
			Pergunta4INForm.Show();
			this.Hide();
