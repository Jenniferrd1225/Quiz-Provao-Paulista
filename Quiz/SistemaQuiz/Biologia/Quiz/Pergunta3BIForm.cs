...
{
	/// <summary>
	/// Description of Pergunta3BIForm.
	/// </summary>
	public partial class Pergunta3BIForm : Form
	{
		int pontosBI;
		public Pergunta3BIForm(int pontos)
		{
			//
		         ...
		         void BtnBClick(object sender, EventArgs e)
        {
            ...
            Pergunta4BIForm Pergunta4BIForm = new Pergunta4BIForm(pontosBI);
			Pergunta4BIForm.Show();
			this.Hide();
