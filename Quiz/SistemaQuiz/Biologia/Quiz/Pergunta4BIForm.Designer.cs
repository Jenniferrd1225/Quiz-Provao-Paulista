...
namespace SistemaQuiz
{
	partial class Pergunta4BIForm
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Pergunta4BIForm));
			...
			this.label9.Text = "D) Transpiração das plantas.";
			...
			this.label10.Text = "C) Precipitação (chuva, neve).";
			...
			this.label8.Text = "B) Escoamento superficial.";
			...
			this.label6.Text = "A) Infiltração no solo.";
			...
			this.label5.Text = "O ciclo hidrológico é fundamental para os ecossistemas. A água que evapora dos oc" +
			"eanos retorna à terra firme principalmente por meio de:";
			...
			this.Name = "Pergunta4BIForm";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Pergunta4BIForm";
