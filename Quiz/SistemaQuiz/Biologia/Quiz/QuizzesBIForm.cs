...
{
	/// <summary>
	/// Description of QuizzesBIForm.
	/// </summary>
	public partial class QuizzesBIForm : Form
	{
		public QuizzesBIForm()
		{
			//
		...
		{
            Pergunta1BIForm Pergunta1BIForm = new Pergunta1BIForm();
            Pergunta1BIForm.Show();
            this.Hide();
		}
    }
}
