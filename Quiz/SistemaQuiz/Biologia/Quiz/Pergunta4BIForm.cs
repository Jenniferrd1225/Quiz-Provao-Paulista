...
{
	/// <summary>
	/// Description of Pergunta4BIForm.
	/// </summary>
	public partial class Pergunta4BIForm : Form
	{
		int pontosBI;
		public Pergunta4BIForm(int pontos)
		{
			//
		         ...
		         void BtnBClick(object sender, EventArgs e)
        {
            ...
            Pergunta5BIForm Pergunta5BIForm = new Pergunta5BIForm(pontosBI);
			Pergunta5BIForm.Show();
			this.Hide();
