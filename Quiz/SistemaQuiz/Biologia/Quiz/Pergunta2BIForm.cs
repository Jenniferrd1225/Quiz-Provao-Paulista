...
{
	/// <summary>
	/// Description of Pergunta2BIForm.
	/// </summary>
	public partial class Pergunta2BIForm : Form
	{
		int pontosBI;
		public Pergunta2BIForm(int pontos)
		{
			//
		         ...
		         void BtnBClick(object sender, EventArgs e)
        {
            ...
            Pergunta3BIForm Pergunta3BIForm = new Pergunta3BIForm(pontosBI);
			Pergunta3BIForm.Show();
			this.Hide();
