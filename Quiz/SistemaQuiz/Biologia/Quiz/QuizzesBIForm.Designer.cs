...
namespace SistemaQuiz
{
	partial class QuizzesBIForm
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(QuizzesBIForm));
			...
			this.label2.Text = "Possuímos 1 quiz sobre Biologia, composto por 5\r\nperguntas. Cada pergunta vale po" +
	"r 1 ponto.";
			...
			this.label1.Text = "QUIZ DE BIOLOGIA";
	...
	"bono — Ciclo do Oxigênio.\r\n";
			...
			this.Name = "QuizzesBIForm";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "QuizzesBIForm";
