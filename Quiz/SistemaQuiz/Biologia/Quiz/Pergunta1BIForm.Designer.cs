...
namespace SistemaQuiz
{
	partial class Pergunta1BIForm
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Pergunta1BIForm));
			...
			this.label9.Text = "D) Eutrofização de lagos e erupções vulcânicas.";
			...
			this.label10.Text = "C) Queima de combustíveis fósseis e desmatamento.";
			...
			this.label8.Text = "B) Fixação do nitrogênio e combustão de biomassa.";
			...
			this.label6.Text = "A) Fotossíntese e respiração celular.";
			...
			this.Name = "Pergunta1BIForm";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Pergunta1BIForm";
