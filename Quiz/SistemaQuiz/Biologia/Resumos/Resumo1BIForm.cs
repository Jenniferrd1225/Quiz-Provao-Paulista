...
{
	/// <summary>
	/// Description of Resumo1BIForm.
	/// </summary>
	public partial class Resumo1BIForm : Form
	{
		public Resumo1BIForm()
		{
			//
		...
		void BtnProximaClick(object sender, EventArgs e)
		{
			...
			FinalizarResumoBIForm FinalizarResumoBIForm = new FinalizarResumoBIForm(pontosRB);
			FinalizarResumoBIForm.Show();
			this.Hide();	
		}
	}
}
