...
namespace SistemaQuiz
{
	partial class ResumosBIForm
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ResumosBIForm));
			...
			this.label2.Text = "Possuímos 1 resumo de Biologia. Cada resumo vale 10\r\npontos, e eles serão somados" +
	" após a conclusão da leitura.";
			...
			this.label1.Text = "RESUMO DE BIOLOGIA";
			...
			this.label5.Text = "TEMA: Ciclos Biogeoquímicos\r\n\r\nCONTEÚDO: O que são — Ciclo da Água — Ciclo do Car" +
	"bono — Ciclo do Oxigênio.\r\n";
			// 
			// label8
			// 
			...
			this.Name = "ResumosBIForm";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "ResumosBIForm";
