...
namespace SistemaQuiz
{
	partial class ResumosMTForm
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ResumosMTForm));
			...
			this.panel4.Size = new System.Drawing.Size(678, 106);
			...
			this.label6.Size = new System.Drawing.Size(649, 67);
			this.label6.TabIndex = 138;
			this.label6.Text = "TEMA: Função do 1° e 2° grau\r\n\r\nCONTEÚDO: Definição — Coeficientes — Gráfico — Co" +
	"ncavidade.\r\n\r\n";
			// 
			// label9
			// 
			...
			this.label2.Text = "Possuímos 1 resumo de matemática. Cada leitura finalizada soma 10 pontos.";
			...
			this.label1.Text = "RESUMO DE MATEMÁTICA";
			...
			this.Name = "ResumosMTForm";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "ResumosMTForm";
