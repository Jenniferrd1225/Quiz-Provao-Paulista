...
{
	/// <summary>
	/// Description of Pergunta3MTForm.
	/// </summary>
	public partial class Pergunta3MTForm : Form
	{
		int pontosMT;
		public Pergunta3MTForm(int pontos)
		{
			//
		...
		void BtnBClick(object sender, EventArgs e)
        {
            ...
            Pergunta4MTForm Pergunta4MTForm = new Pergunta4MTForm(pontosMT);
            Pergunta4MTForm.Show();
            this.Hide();
