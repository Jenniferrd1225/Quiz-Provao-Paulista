...
{
	/// <summary>
	/// Description of Pergunta1MTForm.
	/// </summary>
	public partial class Pergunta1MTForm : Form
	{
		public Pergunta1MTForm()
		{
			//
		...
		void BtnBClick(object sender, EventArgs e)
        {
            ...
            Pergunta2MTForm Pergunta2MTForm = new Pergunta2MTForm(pontosMT);
            Pergunta2MTForm.Show();
            this.Hide();
