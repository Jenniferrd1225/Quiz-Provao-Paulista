...
namespace SistemaQuiz
{
	partial class QuizzesMTForm
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(QuizzesMTForm));
			...
			this.panel1.Size = new System.Drawing.Size(169, 515);
			...
			this.panel3.Controls.Add(this.btnQuiz1);
			...
			this.label5.Text = "TEMA: Função do 1° e 2° grau\r\n\r\nCONTEÚDO: Definição — Coeficientes — Gráfico — Co" +
	"ncavidade.\r\n\r\n";
			// 
			// label4
			// 
			...
			this.label8.Size = new System.Drawing.Size(528, 39);
			...
			this.label2.Text = "Possuímos 1 quiz de matemática, composto por 5 perguntas. Cada pergunta vale por " +
	"1 ponto.";
			...
			this.label1.Text = "QUIZZES DE MATEMÁTICA";
			...
			this.Name = "QuizzesMTForm";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "QuizzesMTForm";
