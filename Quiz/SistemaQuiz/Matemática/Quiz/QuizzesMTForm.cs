...
{
	/// <summary>
	/// Description of QuizzesMTForm.
	/// </summary>
	public partial class QuizzesMTForm : Form
	{
		public QuizzesMTForm()
		{
			//
		...
		void BtnQuiz1Click(object sender, EventArgs e)
		{
            Pergunta1MTForm Pergunta1MTForm = new Pergunta1MTForm();
            Pergunta1MTForm.Show();
            this.Hide();
		}
    }
}