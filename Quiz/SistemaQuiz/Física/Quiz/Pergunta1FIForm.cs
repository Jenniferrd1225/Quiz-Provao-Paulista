...
{
	/// <summary>
	/// Description of Pergunta1FIForm.
	/// </summary>
	public partial class Pergunta1FIForm : Form
	{
		public Pergunta1FIForm()
		{
			//
		 ...
		 void BtnBClick(object sender, EventArgs e)
        {
            ...
            Pergunta2FIForm Pergunta2FIForm = new Pergunta2FIForm(pontosFI);
			Pergunta2FIForm.Show();
			this.Hide();
