...
{
	/// <summary>
	/// Description of QuizzesFIForm.
	/// </summary>
	public partial class QuizzesFIForm : Form
	{
		public QuizzesFIForm()
		{
			//
		...
		{
            Pergunta1FIForm Pergunta1FIForm = new Pergunta1FIForm();
            Pergunta1FIForm.Show();
            this.Hide();
		}
    }
}
