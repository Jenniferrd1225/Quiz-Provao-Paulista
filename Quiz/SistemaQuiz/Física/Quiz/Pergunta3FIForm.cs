...
{
	/// <summary>
	/// Description of Pergunta3FIForm.
	/// </summary>
	public partial class Pergunta3FIForm : Form
	{
		int pontosFI;
		public Pergunta3FIForm(int pontos)
		{
			//
		 ...
		 void BtnBClick(object sender, EventArgs e)
        {
            ...
            Pergunta4FIForm Pergunta4FIForm = new Pergunta4FIForm(pontosFI);
			Pergunta4FIForm.Show();
			this.Hide();
