...
{
	/// <summary>
	/// Description of Pergunta4FIForm.
	/// </summary>
	public partial class Pergunta4FIForm : Form
	{
		int pontosFI;
		public Pergunta4FIForm(int pontos)
		{
			//
		 ...
		 void BtnBClick(object sender, EventArgs e)
        {
            ...
            Pergunta5FIForm Pergunta5FIForm = new Pergunta5FIForm(pontosFI);
			Pergunta5FIForm.Show();
			this.Hide();
