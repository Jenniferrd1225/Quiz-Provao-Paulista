...
{
	/// <summary>
	/// Description of Resumo1FIForm.
	/// </summary>
	public partial class Resumo1FIForm : Form
	{
		public Resumo1FIForm()
		{
			//
		...
		void BtnProximaClick(object sender, EventArgs e)
		{
			...
			FinalizarResumoFIForm FinalizarResumoFIForm = new FinalizarResumoFIForm(pontosRF);
			FinalizarResumoFIForm.Show();
			this.Hide();		
		}
	}
}