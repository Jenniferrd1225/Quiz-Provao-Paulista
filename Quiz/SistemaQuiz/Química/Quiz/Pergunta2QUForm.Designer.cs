...
namespace SistemaQuiz
{
	partial class Pergunta2QUForm
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Pergunta2QUForm));
			...
			this.label9.Text = "D) A carga positiva do átomo estava distribuída uniformemente por toda sua extens" +
	"ão";
			...
			this.label10.Text = "C) O átomo possuía um núcleo pequeno, denso e positivo, cercado por espaços vazio" +
	"s";
			...
			this.label8.Text = "B) Os elétrons ocupavam órbitas específicas ao redor do núcleo, como no modelo de" +
	" Bohr";
			...
			this.label6.Text = "A) O átomo era uma esfera maciça e positiva, conforme o modelo de Thomson";
			...
			this.Name = "Pergunta2QUForm";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Pergunta2QUForm";
