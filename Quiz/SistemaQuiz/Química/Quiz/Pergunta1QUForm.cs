...
{
	/// <summary>
	/// Description of Pergunta1QUForm.
	/// </summary>
	public partial class Pergunta1QUForm : Form
	{
		public Pergunta1QUForm()
		{
			//
		         ...
		         void BtnBClick(object sender, EventArgs e)
        {
            ...
            Pergunta2QUForm Pergunta2QUForm = new Pergunta2QUForm(pontosQU);
            Pergunta2QUForm.Show();
            this.Hide();
