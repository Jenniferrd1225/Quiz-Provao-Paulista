...
{
	/// <summary>
	/// Description of QuizzesQUForm.
	/// </summary>
	public partial class QuizzesQUForm : Form
	{
		public QuizzesQUForm()
		{
			//
		...
		void BtnResumo1Click(object sender, EventArgs e)
		{
			Pergunta1QUForm Pergunta1QUForm = new Pergunta1QUForm();
			Pergunta1QUForm.Show();
			this.Hide();
		}
	}
}
