...
{
	/// <summary>
	/// Description of Pergunta5QUForm.
	/// </summary>
	public partial class Pergunta5QUForm : Form
	{
		int pontosQU;
		public Pergunta5QUForm(int pontos)
		{
			//
        ...
        {
            FinalizarQuizQUForm FinalizarQuizQUForm = new FinalizarQuizQUForm(pontosQU);
            FinalizarQuizQUForm.Show();
            this.Hide();
        }
    }
}
