...
namespace SistemaQuiz
{
	partial class QuizzesHIForm
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(QuizzesHIForm));
			...
			this.label2.Text = "Possuímos 1 quiz de história, composto por 5 perguntas. Cada pergunta vale por 1 " +
	"ponto.";
			...
			this.label1.Text = "QUIZZES DE HISTÓRIA";
	...
	"gações — Espaço Atlântico — Consequências.\r\n\r\n";
			...
			this.Name = "QuizzesHIForm";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "QuizzesHIForm";
