...
{
	/// <summary>
	/// Description of Pergunta5HIForm.
	/// </summary>
	public partial class Pergunta5HIForm : Form
	{
		int pontosHI;
		public Pergunta5HIForm(int pontos)
		{
			//
		...
		{
			FinalizarQuizHIForm FinalizarQuizHIForm = new FinalizarQuizHIForm(pontosHI);
            FinalizarQuizHIForm.Show();
            this.Hide();			
		}
    }
}
