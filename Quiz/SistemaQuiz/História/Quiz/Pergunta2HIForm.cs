...
{
	/// <summary>
	/// Description of Pergunta2HIForm.
	/// </summary>
	public partial class Pergunta2HIForm : Form
	{
		int pontosHI;
		public Pergunta2HIForm(int pontos)
		{
			//
		      ...
		      void BtnBClick(object sender, EventArgs e)
        {
            ...
            Pergunta3HIForm Pergunta3HIForm = new Pergunta3HIForm(pontosHI);
            Pergunta3HIForm.Show();
            this.Hide();
