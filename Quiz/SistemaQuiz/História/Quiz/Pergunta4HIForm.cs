...
{
	/// <summary>
	/// Description of Pergunta4HIForm.
	/// </summary>
	public partial class Pergunta4HIForm : Form
	{
		int pontosHI;
		public Pergunta4HIForm(int pontos)
		{
			//
		      ...
		      void BtnBClick(object sender, EventArgs e)
        {
            ...
            Pergunta5HIForm Pergunta5HIForm = new Pergunta5HIForm(pontosHI);
            Pergunta5HIForm.Show();
            this.Hide();
