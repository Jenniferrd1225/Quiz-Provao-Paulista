...
namespace SistemaQuiz
{
	partial class ResumosHIForm
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ResumosHIForm));
			...
			this.label2.Text = "Possuímos 1 resumo de história. Cada leitura finalizada soma 10 pontos.";
			...
			this.label1.Text = "RESUMOS DE HISTÓRIA";
			...
			this.label5.Text = "TEMA: Expansão Marítima Européia\r\n\r\nCONTEÚDO: Contexto — Causas — Principais Nave" +
	"gações — Espaço Atlântico — Consequências.\r\n\r\n";
			// 
			// label8
			// 
			...
			this.Name = "ResumosHIForm";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "ResumosHIForm";
