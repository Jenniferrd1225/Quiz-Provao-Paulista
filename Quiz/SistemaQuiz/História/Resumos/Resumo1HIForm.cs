...
{
	/// <summary>
	/// Description of Resumo1HIForm.
	/// </summary>
	public partial class Resumo1HIForm : Form
	{
		public Resumo1HIForm()
		{
			//
		...
		void Button2Click(object sender, EventArgs e)
		{
            ...
            FinalizarResumoHIForm FinalizarResumoHIForm = new FinalizarResumoHIForm(pontosRH);
            FinalizarResumoHIForm.Show();
            this.Hide();
         }
