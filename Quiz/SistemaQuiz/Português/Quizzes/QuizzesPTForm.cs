...
{
	/// <summary>
	/// Description of QuizzesPTForm.
	/// </summary>
	public partial class QuizzesPTForm : Form
	{
		public QuizzesPTForm()
		{
			//
		...
		void BtnQuiz2Click(object sender, EventArgs e)
		{
			Pergunta1Q2PTForm pergunta1Q2PTForm = new Pergunta1Q2PTForm();
			pergunta1Q2PTForm.Show();
    		this.Hide();
		}
	}
}
