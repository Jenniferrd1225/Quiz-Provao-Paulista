...
{
	/// <summary>
	/// Description of Pergunta3Q2PTForm.
	/// </summary>
	public partial class Pergunta3Q2PTForm : Form
	{
		int pontosPT;
		public Pergunta3Q2PTForm(int pontos)
		{
			//
		...
		void BtnBClick(object sender, EventArgs e)
		{
		    ...
		    Pergunta4Q2PTForm Pergunta4Q2PTForm = new Pergunta4Q2PTForm(pontosPT);
			Pergunta4Q2PTForm.Show();
			this.Hide();
		}
