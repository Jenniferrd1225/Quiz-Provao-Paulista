# SABI+ — Sistema Educacional com Quizzes
### Quiz: Provão Paulista

Projeto desenvolvido por Íris Okumura e Jennifer Rodrigues  
ETEC de Taboão da Serra — Desenvolvimento de Sistemas
...
O sistema oferece conteúdos de estudo por meio de **resumos**, **quizzes interativos** e um sistema
de **pontuação**, além de disponibilizar informações sobre universidades, cursos mais disputados e
vestibulares aceitos por cada instituição.
...
- Experiência do usuário em aplicações desktop
...
- Ranking com os usuários de maior pontuação
- Informações sobre universidades (USP, UNESP, UNICAMP, FATEC)
- Simulação de planos de assinatura (gratuito e pago)
...
- Regras de pontuação aplicadas automaticamente
